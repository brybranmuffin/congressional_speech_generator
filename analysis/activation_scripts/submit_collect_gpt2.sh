#!/bin/bash
#SBATCH --job-name=gpt2_activations
...
#SBATCH --output=activations/logs/gpt2_collect_%j.out
#SBATCH --error=activations/logs/gpt2_collect_%j.err
...
echo "======================================"
echo "GPT-2 Activation Collection"
...
echo "======================================"
$PYTHON collect_activations_gpt2.py \
    --n_speeches 1000000 \
    --layers last \
    --batch_size 32 \
